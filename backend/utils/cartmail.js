...
const cartmail = async(UseremailId, username, orderid, transid, amountpay) => {

    console.log(UseremailId, username)
    ...
    var mailOptions = {
        ...
        <div style="text-align: center; margin-bottom: 12px;">
            ...
            <h2 style="margin: 6px;">Thank you for your order!</h2>
            <a href="#"><button style="padding: 6px 10px; background-color: #6fe211; color: #fff; border-radius: 4px; border: none; outline: none; font-size: 16px; cursor: pointer; font-weight: 500; margin: 10px">Go to My Order</button></a>
        </div>
        ...
        <div style="margin: 35px 10px 15px">
            <div style="text-align: center;">
                <h2 style="margin: 5px">Your shopping order has been placed</h2>
            </div>
        </div>
        ...
        <div style="margin: 25px">
            <div style="font-size: 15px;">
                ...
                <h4>Your Item(s) will be shipped soon! Thanks for shopping with AgroAcers.</h4>
